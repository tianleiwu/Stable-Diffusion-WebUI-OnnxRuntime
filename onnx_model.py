...
# This file is modified from https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/python/tools/transformers/onnx_model.py
...
class OnnxModel:
    ...
    def initialize(self, model):
        ...
        # The following is cache of shape and data type.
    ...
    def remove_useless_cast_nodes(self):
        ...
        def get_data_type(input_or_output_name):
            ...
            if shape_infer and shape_infer.known_vi_[input_or_output_name].type.tensor_type.HasField("elem_type"):
